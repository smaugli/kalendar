<?php
	...
	$mcImageManagerConfig['authenticator.login_page'] = "error.html";
	$mcImageManagerConfig['authenticator.allow_override'] = "*";

	// SessionAuthenticator
	$mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "adminIsLoggedIn";
	...
	$mcImageManagerConfig['SessionAuthenticator.rootpath_key'] = "mcRootpath";
